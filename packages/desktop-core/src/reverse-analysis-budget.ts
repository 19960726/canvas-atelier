...
export function resolveReverseAnalysisBudget(depth: ReverseAnalysisDepth | undefined): ReverseAnalysisBudget {
  if (depth === 'fast') return { maxOutputTokens: 4_096, timeoutMs: 180_000 };
  if (depth === 'deep') return { maxOutputTokens: 16_384, timeoutMs: 600_000 };
  return { maxOutputTokens: 8_192, timeoutMs: 360_000 };
}
