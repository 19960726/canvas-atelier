...
describe('desktop packaging boundary', () => {
  it('keeps the 1.6.129 modern installer in its own builder output and excludes legacy output', async () => {
    ...
    expect(packageJson.version).toBe('1.6.129');
    ...
    expect(installerPath).toBe(resolve(
      ...
      'dist-builder',
      'desktop-modern',
      'CanvasAtelier-Win10-11-x64-1.6.129.exe',
    ));
