...
| Focused unit review suite | passed | `npm test -- packages/domain/src/project-memory.test.ts apps/renderer/src/history/SkillCandidateReview.test.tsx apps/renderer/src/app/app-store.test.ts apps/renderer/src/app/knowledge-client.test.ts packages/desktop-core/src/bridge-contract.test.ts` -> 140 passed | Covers persistent Skill candidate review preparation status, disabled approve/reject while preparing or non-reviewable, stale prepare discard, bridge fingerprint/revision conflict handling, and e2e test-mode bridge parity. |
| Unit/integration suite | passed | `npm test` -> 762 passed, 2 skipped | Performance-only suites remain skipped unless their explicit perf env vars are set. |
